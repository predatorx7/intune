...
public class AppAccount {
  ...
  /**
   * Reconstitute the account object from the provided settings, where it was previously saved.
   *
   * @param sharedPref the preferences.
   * @return the reconstituted account object, or null if insufficient data was found in the
   *     settings.
   */

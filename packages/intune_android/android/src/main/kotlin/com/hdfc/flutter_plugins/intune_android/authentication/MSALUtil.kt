...
object MSALUtil {
    ...
    fun acquireToken(fromActivity: Activity, scopes: Array<String?>,
                     loginHint: String?, callback: AuthenticationCallback) {
    ...
    @WorkerThread
    @Throws(MsalException::class, InterruptedException::class)
    fun acquireTokenSilent(appContext: Context, aadId: String, scopes: Array<String?>,
        ...
        if (account == null) {
            ...
            callback.onError(
                    MsalUiRequiredException(MsalUiRequiredException.NO_ACCOUNT_FOUND, "no account found for $aadId"))
            return
        }
    ...
    @WorkerThread
    @Throws(MsalException::class, InterruptedException::class)
    fun acquireTokenSilentSync(appContext: Context, aadId: String, scopes: Array<String?>): IAuthenticationResult {
